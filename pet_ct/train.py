...
parser.add_argument('--num_classes', type=int, default=2, help='the number of classes')#换class_num
parser.add_argument('--epochs', type=int, default=1, help='the number of training epoch')
...
#parser.add_argument('--data_path', type=str, default="C:/Users/ChinHaiMei/OneDrive/文档/PythonProject/Dataset/flower")#这里要改
#parser.add_argument('--data_path', type=str, default="C:/ThyroidNodules/Dataset/thyriodnodules")
parser.add_argument('--data_path', type=str, default=r"G:\lh\ThyroidNodules\Dataset\thyriodnodules")
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        with open(os.path.join(save_path, "resnet_big_log.txt"), 'a') as f: #这里要改不同模型
        ...
        if val_acc > best_acc:
            best_acc = val_acc
            torch.save(model.state_dict(), os.path.join(save_path, "resnet_big.pth")) #这里也要改
